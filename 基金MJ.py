...
ticker = 'aCDD04'  # 安聯
# ticker = 'ACDF07'  # 台中銀數位基金
# ticker = 'ACKH19'  # 野村高科技基金
# ticker = 'acps10'  # 統一奔騰
RERUN = True
...
ax1[0].bar(funds_dict['Date'], funds_dict['weighted MACD'], label='weighted MACD', color=colors)
ax2 = ax1[0].twinx()
ax2.plot(funds_dict['Date'], np.array(funds_dict['weighted J'])-0.5, label='weighted J', color='k')
ax2.set_ylim([-2, 2])
